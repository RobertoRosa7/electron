...
export class FormIncomingComponent implements OnInit {
  ...
  constructor(
    ...
    this.form = this._fb.group({ value: [''], date: [new Date()], description: '' })
  ...
  public ngOnInit(): void {
    ...
    this.form.get('description')?.valueChanges.subscribe(text => this.charCount = (this.charTotal - text.length))
  }
